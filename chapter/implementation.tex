...
% \subsection{Struktur des Systems}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.7\linewidth]{impl/code_options.png}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.7\linewidth]{impl/code_composition.png}
...
Diese Daten werden nun nach Bedarf an die Komponenten der Ansicht weitergegeben.
