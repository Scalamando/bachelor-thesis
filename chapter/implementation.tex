...
Dieser Abschnitt präsentiert die bedeutendsten technischen Aspekte des Frontends.
...
Datentypen von Strapi (vgl. \ssecref{ssec:impl-backend-structure}). Jedoch kann
...
\ssecref{ssec:impl-backend-push}). Um ein paar zu generieren, kann
