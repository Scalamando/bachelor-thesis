...
\begin{figure}[htpb]
    ...
    \tikz [thesis box shapes, baseline, anchor=base, scale=0.8]{
        ...
        \coordinate [right=0.35cm of {$(1a.east)!0.5!(1b.east)$}] (1X);

        \node [block] (2a) [textbox, small, right=0.35cm of 1X] {\textbf{Mittlere Priorität}\linebreak„soll“};
        ...
        \coordinate [right=0.35cm of 2a] (2X);

        \node [block] (3a) [textbox, big, right=0.35cm of 2X] {\textbf{Benutzerinteraktion}\linebreak„<Wem> die Möglichkeit bieten“};
        ...
        \node [block] (5) [textbox, medium, right=0.35cm of 4, yshift=-2cm]
        {\textbf{Bei Qualitätsanforderungen}\linebreak„<Qualität>“};
