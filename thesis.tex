...
\UzLThesisSetup{
    ...
    Abstract                = { Digital media have greatly facilitated access to
        ...
        interface. This includes project locations, an introduction and help for
        the event. With the help of a dashboard, statistics on visitors and
        stations can be viewed, notifications can be sent to participants and
        feedback can be requested. Participants access is facilitated in a
        clearly structured web app. There they can view and virtually visit
        stations, submit badges and view help entries. As a basis, the existing
        EMI-Award app was analysed. In addition, interviews with participants
        and organisers were conducted to understand the processes of organising
        the event and problems in the implementation and participation. The
        system was then designed and implemented. Finally, the system was used
        in two events and evaluated with participants and organisers.
    ...
    Zusammenfassung         = { Die digitalen Medien haben den Zugang zu
        ...
        unterstützt Veranstalter bei der Organisation und Durchführung von
        Veranstaltungen, indem es ihnen ermöglicht, veranstaltungsrelevante
        Informationen über ein Webinterface zu verwalten. Dazu gehören
        Projektstandorte, Einführung und Hilfe zur Veranstaltung. Mit Hilfe
        eines Dashboards können Statistiken über Teilnehmende und Stationen
        eingesehen, Benachrichtigungen an Teilnehmende verschickt und Feedback
        abgefragt werden. Teilnehmenden wird der Zugang in einer übersichtlichen
        Web-App erleichtert. Dort können sie Stationen einsehen und virtuell
        besuchen, Badges abgeben und Hilfeeinträge einsehen. Als Grundlage wurde
        die bestehende EMI-Award-App analysiert. Darüber hinaus wurden
        Interviews mit Teilnehmenden und Veranstaltenden geführt, um die Abläufe
        bei der Organisation der Veranstaltung und Probleme bei der Umsetzung
        und Teilnahme zu verstehen. Anschließend wurde das System entworfen und
        implementiert. Schließlich wurde das System bei zwei Veranstaltungen
...
\input{chapter/dialog_example.tex}
